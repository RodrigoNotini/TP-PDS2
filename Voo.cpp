#include "Voo.hpp"
using namespace std;
Voo::Voo(const string& _origem,const string& _destino,int _num_assentos,vector<bool>_assentos)
        :origem(_origem),destino(_destino),num_assentos(_num_assentos),assentos(_assentos){}
